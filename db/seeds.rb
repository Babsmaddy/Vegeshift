...
#   recipe_ingredients = recipe_data.delete(:ingredients)
  ...
  recipes = Recipe.all
  dailies = [
    { recipe: recipes.sample, date: (Date.today - 19), user: user },
    { recipe: recipes.sample, date: (Date.today - 20), user: user },
    { recipe: recipes.sample, date: (Date.today - 21), user: user },
    { recipe: recipes.sample, date: (Date.today - 22), user: user },
    { recipe: recipes.sample, date: (Date.today - 23), user: user },
    { recipe: recipes.sample, date: (Date.today - 24), user: user },
    { recipe: recipes.sample, date: (Date.today - 25), user: user },
    { recipe: recipes.sample, date: (Date.today - 26), user: user },
    { recipe: recipes.sample, date: (Date.today - 27), user: user },
    { recipe: recipes.sample, date: (Date.today - 28), user: user },
    { recipe: recipes.sample, date: (Date.today - 29), user: user },
    { recipe: recipes.sample, date: (Date.today - 30), user: user },
    { recipe: recipes.sample, date: (Date.today - 31), user: user },
    { recipe: recipes.sample, date: (Date.today - 32), user: user },
    { recipe: recipes.sample, date: (Date.today - 33), user: user },
    { recipe: recipes.sample, date: (Date.today - 34), user: user },
    { recipe: recipes.sample, date: (Date.today - 35), user: user },
    { recipe: recipes.sample, date: (Date.today - 36), user: user },
    { recipe: recipes.sample, date: (Date.today - 37), user: user },
    { recipe: recipes.sample, date: (Date.today - 38), user: user },
    { recipe: recipes.sample, date: (Date.today - 39), user: user },
    { recipe: recipes.sample, date: (Date.today - 40), user: user },
    { recipe: recipes.sample, date: (Date.today - 41), user: user },
    { recipe: recipes.sample, date: (Date.today - 42), user: user },
    { recipe: recipes.sample, date: (Date.today - 43), user: user },
    { recipe: recipes.sample, date: (Date.today - 44), user: user },
    { recipe: recipes.sample, date: (Date.today - 45), user: user },
    { recipe: recipes.sample, date: (Date.today - 46), user: user },
    { recipe: recipes.sample, date: (Date.today - 47), user: user },
    { recipe: recipes.sample, date: (Date.today - 48), user: user },
    { recipe: recipes.sample, date: (Date.today - 49), user: user },
    { recipe: recipes.sample, date: (Date.today - 50), user: user },
    { recipe: recipes.sample, date: (Date.today - 51), user: user },
    { recipe: recipes.sample, date: (Date.today - 52), user: user },
    { recipe: recipes.sample, date: (Date.today - 53), user: user },
    { recipe: recipes.sample, date: (Date.today - 54), user: user },
    { recipe: recipes.sample, date: (Date.today - 55), user: user },
    { recipe: recipes.sample, date: (Date.today - 56), user: user },
    { recipe: recipes.sample, date: (Date.today - 57), user: user },
    { recipe: recipes.sample, date: (Date.today - 58), user: user },
    { recipe: recipes.sample, date: (Date.today - 59), user: user },
    { recipe: recipes.sample, date: (Date.today - 60), user: user },
    { recipe: recipes.sample, date: (Date.today - 61), user: user },
    { recipe: recipes.sample, date: (Date.today - 62), user: user },
    { recipe: recipes.sample, date: (Date.today - 63), user: user },
    { recipe: recipes.sample, date: (Date.today - 64), user: user },
    { recipe: recipes.sample, date: (Date.today - 65), user: user },
    { recipe: recipes.sample, date: (Date.today - 66), user: user },
    { recipe: recipes.sample, date: (Date.today - 67), user: user },
    { recipe: recipes.sample, date: (Date.today - 68), user: user },
  ]
